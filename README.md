...
*Web servers.*
  ...
  * [Traefic](https://traefik.io/) - HTTP reverse proxy and load balancer supports several backends (Docker, Swarm, Mesos/Marathon, Kubernetes, Consul, Etcd, Zookeeper, BoltDB, Rest API, file…) to manage its configuration.
  * [Fabio](https://github.com/eBay/fabio) - A zero-conf load balancing HTTP(S) router for deploying microservices managed by consul.
